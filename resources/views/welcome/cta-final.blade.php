            ...
            <div class="cta-final rounded-3xl p-12 sm:p-16 text-center relative">
                ...
                <div class="relative">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500/15 border border-blue-500/30 mb-6">
                        <i class="fa-solid fa-futbol text-blue-500 text-2xl"></i>
                    </div>

                    <h2 class="font-editorial uppercase italic text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-4 leading-[0.95]">
                        Lleva tu colegio al
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="{{ route('login') }}"
                           class="btn-ghost inline-flex items-center justify-center gap-2 px-8 py-4 text-slate-800 font-semibold rounded-xl">
                            Iniciar sesión
